...
\noindent
\begin{theorem}
(SKIP THIS WRONG THEOREM, HERE MISTAKENLY $\vdash_w=\vdash$)
\\Let's prove the translation of
$$\allI:``\left(\bigwedge t. P(t)\right)==> \forall x. P(x)".$$
Its translation is
$$(\forall t\in \Term. \Tau \vdash P(t))\longrightarrow \Tau \vdash \forall x. P(x).$$
\myprf
\\We have a hypothesis H:$(\forall x\in \Term. \Tau \vdash P(x))$.
